...
- **v2.16.0** (2024-08-06): **JDK 21 baseline** - Upgraded baseline JDK from 11/17 to 21 for both backend and dashboards plugins, aligning with OpenSearch 3.0.0 requirements; CI/CD workflows updated to use JDK 21 exclusively
...
| v2.19.0 | [#1358](https://github.com/opensearch-project/anomaly-detection/pull/1358) | Adding feature direction rules | [#616](https://github.com/opensearch-project/anomaly-detection/issues/616) |
| v2.19.0 | [#1401](https://github.com/opensearch-project/anomaly-detection/pull/1401) | Add flattened custom result index |   |
| v2.19.0 | [#1362](https://github.com/opensearch-project/anomaly-detection/pull/1362) | Changing replica count to 0-2 for custom result index |   |
| v2.19.0 | [#960](https://github.com/opensearch-project/anomaly-detection-dashboards-plugin/pull/960) | Adding feature direction and moving suppression rules to each feature |   |
...
| v2.16.0 | [#1228](https://github.com/opensearch-project/anomaly-detection/pull/1228) | Set baseline JDK version to JDK-21 | [#1223](https://github.com/opensearch-project/anomaly-detection/issues/1223) |
| v2.16.0 | [dashboards#798](https://github.com/opensearch-project/anomaly-detection-dashboards-plugin/pull/798) | Update Frontend CI to use JDK21 |   |
