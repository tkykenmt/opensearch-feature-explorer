...
- **v2.19.0** (2025-02-18): Fixed QueryGroupTask warning log spam when using scroll API (PR #16981 backported); Added `isQueryGroupSet` flag to track explicit query group assignment; Modified resource tracker to filter tasks without query group set
