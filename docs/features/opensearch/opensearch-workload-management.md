...
- **v2.19.0** (2025-02-18): Added comprehensive integration tests (`WorkloadManagementIT`) for WLM core functionality including CPU/memory enforcement, monitor-only mode, and task cancellation scenarios (PR #16359); Tests validate enforced mode cancellation behavior and monitor-only mode passthrough; Exposed `ExceptionCatchingListener` and `TaskFactory` from `SearchBackpressureIT` for test reuse
...
| v2.19.0 | [#16359](https://github.com/opensearch-project/OpenSearch/pull/16359) | OpenSearch | Add Workload Management IT | [#12342](https://github.com/opensearch-project/OpenSearch/issues/12342) |
