...
- **v2.16.0** (2024-08-06): Added `update_fields` parameter to Update Workflow API for partial field updates on provisioned workflows; Added `allow_delete` parameter to Deprovision API with new DeleteIndexStep, DeleteIngestPipelineStep, and DeleteSearchPipelineStep; Improved Template and WorkflowState builders with static `.builder()` pattern and partial state update capability; Bug fixes for deprovision error handling (NOT_FOUND exceptions treated as successful deletions for models/agents), system index mapping _doc wrapper, and FlowFrameworkException status code recognition by ExceptionsHelper
...
| v3.0.0 | [#1026](https://github.com/opensearch-project/flow-framework/pull/1026) | Fix breaking changes for 3.0.0 release | [#8110](https://github.com/opensearch-project/OpenSearch/issues/8110) |
...
| v2.16.0 | [#757](https://github.com/opensearch-project/flow-framework/pull/757) | Support editing of certain workflow fields on a provisioned workflow | [#749](https://github.com/opensearch-project/flow-framework/issues/749) |
| v2.16.0 | [#763](https://github.com/opensearch-project/flow-framework/pull/763) | Add allow_delete parameter to Deprovision API | [#748](https://github.com/opensearch-project/flow-framework/issues/748) |
| v2.16.0 | [#778](https://github.com/opensearch-project/flow-framework/pull/778) | Improve Template and WorkflowState builders | [#713](https://github.com/opensearch-project/flow-framework/issues/713) |
