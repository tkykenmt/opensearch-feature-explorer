...
| v3.3.0 | [#4138](https://github.com/opensearch-project/ml-commons/pull/4138) | Fix: Agent/Tool Parsing | [#4135](https://github.com/opensearch-project/ml-commons/issues/4135) |
| v3.3.0 | [#4189](https://github.com/opensearch-project/ml-commons/pull/4189) | Fix: NPE when execute flow agent with multi tenancy is off | [#4186](https://github.com/opensearch-project/ml-commons/issues/4186) |
...
| v3.3.0 | [#4118](https://github.com/opensearch-project/ml-commons/pull/4118) | Fix: Missing RAG response from generative_qa_parameters | [#4018](https://github.com/opensearch-project/ml-commons/issues/4018) |
...
| v3.1.0 | [#3883](https://github.com/opensearch-project/ml-commons/pull/3883) | Fix: Change SearchIndexTool arguments parsing logic | [#3834](https://github.com/opensearch-project/ml-commons/issues/3834) |
...
| v2.18.0 | [#3100](https://github.com/opensearch-project/ml-commons/pull/3100) | Fix: Gracefully handle error when generative_qa_parameters is not provided | [#3092](https://github.com/opensearch-project/ml-commons/issues/3092) |
| v2.18.0 | [#3057](https://github.com/opensearch-project/ml-commons/pull/3057) | Fix: RAG processor NPE when optional parameters not provided | [#2983](https://github.com/opensearch-project/ml-commons/issues/2983) |
| v2.18.0 | [#2985](https://github.com/opensearch-project/ml-commons/pull/2985) | Fix: ML inference ingest processor JsonPath return format | [#2974](https://github.com/opensearch-project/ml-commons/issues/2974) |
| v2.18.0 | [#2922](https://github.com/opensearch-project/ml-commons/pull/2922) | Fix: Populate time fields for connectors on return | [#2890](https://github.com/opensearch-project/ml-commons/issues/2890) |
| v2.18.0 | [#3137](https://github.com/opensearch-project/ml-commons/pull/3137) | Fix: Model stuck in deploying state during node crash/cluster restart | [#2970](https://github.com/opensearch-project/ml-commons/issues/2970) |
...
| v2.18.0 | [#3173](https://github.com/opensearch-project/ml-commons/pull/3173) | Fix: Handle BWC for Bedrock Converse API | [#3126](https://github.com/opensearch-project/ml-commons/issues/3126) |
| v2.17.0 | [#2806](https://github.com/opensearch-project/ml-commons/pull/2806) | Fix: Delete model race condition | [#2793](https://github.com/opensearch-project/ml-commons/issues/2793) |
| v2.17.0 | [#2847](https://github.com/opensearch-project/ml-commons/pull/2847) | Fix: Cohere model validation | [#2829](https://github.com/opensearch-project/ml-commons/issues/2829) |
...
| v2.17.0 | [#2871](https://github.com/opensearch-project/ml-commons/pull/2871) | Fix: List substitution in prompts | [#2839](https://github.com/opensearch-project/ml-commons/issues/2839) |
