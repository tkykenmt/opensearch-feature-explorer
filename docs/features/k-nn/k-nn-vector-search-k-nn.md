...
| v3.6.0 | [#3128](https://github.com/opensearch-project/k-NN/pull/3128) | Adjust merge policy settings to reduce CPU impact during concurrent search and indexing | - |
| v3.6.0 | [#3035](https://github.com/opensearch-project/k-NN/pull/3035) | Fix derived source with dynamic templates returning mask value during bulk indexing | [#3012](https://github.com/opensearch-project/k-NN/issues/3012) |
| v3.6.0 | [#3112](https://github.com/opensearch-project/k-NN/pull/3112) | Improve unit tests by tightening assertions | - |
