...
- **v3.6.0**: Renamed `resource-action-groups.yml` to `resource-access-levels.yml` to align with Security plugin's resource sharing framework rename; bumped assertj-core test dependency from 3.16.1 to 3.27.7
...
|---------|-----|-------------|---------------|
| v3.6.0 | [#1163](https://github.com/opensearch-project/reporting/pull/1163) | Renamed resource-action-groups.yml to resource-access-levels.yml to fix security checks | [security#6018](https://github.com/opensearch-project/security/pull/6018) |
| v3.6.0 | [#1166](https://github.com/opensearch-project/reporting/pull/1166) | Bump assertj-core to 3.27.7 | |
