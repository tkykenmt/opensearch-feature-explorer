...
- Faiss Byte Vector Support (HNSW & IVF)
- ML Inference Search Processors
- Batch Asynchronous Ingestion
- Flow Framework User-Level Access Control

### Experimental
- Application-Based Configuration Templates
- Search-Only Replica Shards
- Approximation Framework for Query Optimization
- Custom Trace Source (OpenTelemetry-based)

## Release Information

- **Release Date**: September 17, 2024
- **Official Announcement**: [Introducing OpenSearch 2.17](https://opensearch.org/blog/introducing-opensearch-2-17)
- **Release Notes**: [opensearch-release-notes-2.17.0.md](https://github.com/opensearch-project/opensearch-build/blob/main/release-notes/opensearch-release-notes-2.17.0.md)
