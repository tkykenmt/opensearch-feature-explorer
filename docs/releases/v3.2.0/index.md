...
|------|----------|-------------|
| [Code Coverage (Gradle)](features/opensearch/opensearch-code-coverage-gradle.md) | feature | Local code coverage generation with Gradle and JaCoCo plugin |
| [Combined Fields Query](features/opensearch/opensearch-combined-fields-query.md) | feature | New combined_fields query with BM25F scoring for multi-field text search |
...
| [Derived Source Integration](features/opensearch/opensearch-derived-source.md) | feature | Integration of derived source feature across get/search/recovery paths |
...
| Item | Category | Description |
|------|----------|-------------|
| [Agentic Search](features/neural-search/neural-search-agentic-search.md) | feature | [Experimental] Natural language search with agentic query clause and translator processor |
...
| [Semantic Field](features/neural-search/neural-search-semantic-field.md) | enhancement | knn_vector field configuration, batch size, prune strategies, chunking, embedding reuse |

### OpenSearch Dashboards

| Item | Category | Description |
|------|----------|-------------|
| [Vended Dashboard Progress](features/opensearch-dashboards/opensearch-dashboards-vended-dashboard-progress.md) | feature | Polling-based index state detection for background data sync progress |
...
| [Static Banner Plugin](features/opensearch-dashboards/static-opensearch-dashboards-banner-plugin.md) | feature | Global configurable header banner for announcements |
...
| [UI Settings Backward Compatibility](features/opensearch-dashboards/ui-settings-dashboards-flow-framework-backward-compatibility.md) | feature | Restore backward compatibility for multi-scope UI settings client |
...
| [Bar Chart Enhancements](features/opensearch-dashboards/opensearch-dashboards-bar-chart-enhancements.md) | feature | Bar size control switch for auto/manual bar sizing |
...
| [Dashboards Code Quality & Testing](features/opensearch-dashboards/opensearch-dashboards-dashboards-code-quality-testing.md) | bugfix | Testing guidelines, @ts-expect-error migration, Cypress tests for Explore, component refactoring |
...
| [Rule-based Auto Tagging](features/opensearch/opensearch-rule-based-auto-tagging.md) | feature | Bug fixes and improvements: stricter attribute extraction, centralized validation, force refresh |
...
| [Settings Management](features/opensearch/opensearch-settings-management.md) | bugfix | Ignore archived settings on update to unblock settings modifications |
...
| [Aggregation Task Cancellation](features/opensearch/opensearch-aggregation-task-cancellation.md) | feature | Add task cancellation checks in aggregators to terminate long-running queries |
...
| [Repository Rate Limiters](features/opensearch/opensearch-repository-rate-limiters.md) | feature | Dynamic rate limiter settings for snapshot/restore operations |
| [Secure Aux Transport Settings](features/opensearch/opensearch-secure-aux-transport-settings.md) | feature | API update to distinguish between auxiliary transport types for SSL configuration |
...
| [Numeric Terms Aggregation Optimization](features/opensearch/opensearch-numeric-terms-aggregation-optimization.md) | feature | QuickSelect algorithm for large bucket count terms aggregations |
| [Numeric Field Skip List](features/opensearch/numeric-field-opensearch-skip-list.md) | feature | Skip list indexing for numeric field doc values to improve range query performance |
| [Scripted Metric Aggregation](features/opensearch/opensearch-scripted-metric-aggregation.md) | feature | Support InternalScriptedMetric in InternalValueCount and InternalAvg reduce methods |
...
| [Streaming Transport & Aggregation](features/opensearch/opensearch-streaming-transport-aggregation.md) | feature | Stream transport framework and streaming aggregation for memory-efficient high-cardinality aggregations |
...
| [Star Tree Index](features/opensearch/opensearch-star-tree-index.md) | feature | IP field search support and star-tree search statistics |
| [Clusterless Mode](features/opensearch/opensearch-clusterless-mode.md) | feature | Experimental clusterless startup mode and custom remote store path prefix |
| [Cluster Info & Resource Stats](features/opensearch/opensearch-cluster-info-resource-stats.md) | feature | Add NodeResourceUsageStats to ClusterInfo for cluster-wide resource visibility |
| [BooleanQuery Rewrite Optimizations](features/opensearch/opensearch-booleanquery-rewrite-optimizations.md) | feature | Extend must_not rewrite to numeric match, term, and terms queries (up to 54x speedup) |
| [Rescore Named Queries](features/opensearch/opensearch-rescore-named-queries.md) | feature | Surface named queries from rescore contexts in matched_queries array |
| [Semantic Version Field Type](features/opensearch/opensearch-semantic-version-field-type.md) | feature | New `version` field type for semantic versioning with proper ordering and range queries |
| [Query Phase Plugin Extension](features/opensearch/opensearch-query-phase-plugin-extension.md) | feature | Plugin extensibility for injecting custom QueryCollectorContext during QueryPhase |
...
| [Pull-based Ingestion](features/opensearch/opensearch-pull-based-ingestion.md) | feature | File-based ingestion plugin (ingestion-fs) for local testing |
...
| [Remote Store Metadata API](features/opensearch/opensearch-remote-store-metadata-api.md) | feature | New cluster-level API to fetch segment and translog metadata from remote store |
| [Java Agent AccessController](features/opensearch/opensearch-java-agent-accesscontroller.md) | feature | OpenSearch replacement for JDK's deprecated AccessController for privileged operations |
...
| [Custom Index Name Resolver](features/opensearch/opensearch-custom-index-name-resolver.md) | feature | Plugin extensibility for custom index name expression resolvers |
| [Workload Management](features/opensearch/opensearch-workload-management.md) | feature | WLM mode validation for CRUD operations, naming consistency updates, logging improvements |
...
| [Hierarchical & ACL-aware Routing](features/opensearch/opensearch-hierarchical-acl-aware-routing.md) | feature | New routing processors for hierarchical paths and ACL-based document co-location |
...
| [Repository Maintenance](features/dashboards-search-relevance/dashboards-search-relevance-repository-maintenance.md) | bugfix | Maintainer updates, issue templates, codecov integration, GitHub Actions dependency bumps |
...
| [SQL/PPL Documentation](features/sql/sql-ppl-documentation.md) | bugfix | Update PPL documentation index and V3 engine limitations |
...
| Item | Category | Description |
|------|----------|-------------|
| [Cross-Cluster Replication](features/cross-cluster-replication/cross-cluster-opensearch-replication.md) | bugfix | Add missing method for RemoteClusterRepository class to fix build failure |
...
| [Lucene-on-Faiss: ADC Support](features/k-nn/k-nn-lucene-on-faiss.md) | enhancement | ADC support for memory-optimized search with binary quantized indexes |
| [Remote Vector Index Build](features/k-nn/k-nn-remote-vector-index-build.md) | bugfix | Don't fall back to CPU on terminal failures during remote index build |
...
| Item | Category | Description |
|------|----------|-------------|
| [CVE Fixes & Dependency Updates](features/multi-repo/cve-fixes-opensearch-dashboards-dependency-updates.md) | bugfix | CVE-2025-48734 (beanutils) and CVE-2025-7783 (form-data) security fixes |
...
| [Build Infrastructure (Gradle/JDK)](features/multi-plugin/multi-plugin-build-infrastructure-gradle-jdk.md) | bugfix | Gradle 8.14/8.14.3, JDK 24 CI support, Maven endpoint updates across 17+ repositories |
...
| [Permission Validation](features/security/security-permission-validation.md) | feature | Query parameter to check API permissions without executing the request |
| [Auxiliary Transport SSL](features/security/security-auxiliary-transport-ssl.md) | feature | TLS support for auxiliary transports (gRPC, etc.) with per-transport SSL configuration |
| [Security FIPS Compliance](features/security/security-opensearch-fips-compliance.md) | enhancement | Full FIPS 140-2 compliance with BC-FIPS libraries and OpenSAML shadow JAR isolation |
...
| Item | Category | Description |
|------|----------|-------------|
| [SPIFFE X.509 SVID Support](features/security/security-spiffe-x.509-svid-support.md) | feature | SPIFFE-based workload identity authentication via SPIFFEPrincipalExtractor |
| [Argon2 Password Hashing](features/security/security-argon2-password-hashing.md) | feature | Argon2 password hashing algorithm support with full parameter configurability |
