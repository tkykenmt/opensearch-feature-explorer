...
- [Approximation Framework](features/opensearch/opensearch-approximation-framework.md) - BKD traversal optimization for skewed datasets with DFS strategy
- [Derived Source](features/opensearch/opensearch-derived-source.md) - Storage optimization by deriving _source from doc_values and stored fields
- [Async Shard Batch Fetch](features/opensearch/opensearch-async-shard-batch-fetch.md) - Enabled by default with 20s timeout for improved cluster manager resilience
- [Crypto/KMS Plugin](features/opensearch/opensearch-crypto-kms-plugin.md) - Decoupled plugin initialization and AWS SDK v2.x dependency upgrade
- [Dependency Bumps](features/opensearch/multi-plugin-dependency-bumps.md) - 21 dependency updates including CVE-2025-27820 fix, Netty, Gson, Azure SDK updates
- [DocRequest Refactoring](features/opensearch/opensearch-docrequest-refactoring.md) - Generic interface for single-document operations
- [File Cache](features/opensearch/opensearch-file-cache.md) - File pinning support and granular statistics for Writable Warm indices
- [FIPS Support](features/opensearch/fips-support.md) - Update FipsMode check for improved BC-FIPS compatibility
- [Lucene Upgrade](features/opensearch/opensearch-lucene-upgrade.md) - Upgrade Apache Lucene from 10.1.0 to 10.2.1
- [Network Configuration](features/opensearch/opensearch-network-configuration.md) - Fix systemd seccomp filter for network.host: 0.0.0.0
- [Percentiles Aggregation](features/opensearch/opensearch-percentiles-aggregation.md) - Switch to MergingDigest for up to 30x performance improvement
- [Plugin Installation](features/opensearch/opensearch-plugin-installation.md) - Fix native plugin installation error caused by PGP public key change
- [Plugin Testing Framework](features/opensearch/opensearch-plugin-testing-framework.md) - Enable testing for ExtensiblePlugins using classpath plugins
- [Pull-based Ingestion](features/opensearch/opensearch-pull-based-ingestion.md) - Lag metrics, error metrics, configurable queue, retries, create mode, write blocks, consumer reset
...
- [Query Optimization](features/opensearch/opensearch-query-optimization.md) - Automatic must_not range rewrite and sort-query performance improvements
- [Remote Store](features/opensearch/opensearch-remote-store.md) - Close index rejection during migration and cluster state diff download fix
...
- [Star-Tree Index Enhancements](features/opensearch/opensearch-star-tree-index.md) - Production-ready status, date range queries, nested aggregations, index-level control
- [Cluster Manager Metrics](features/opensearch/opensearch-cluster-manager-metrics.md) - Task execution time, node-left counter, and FS health failure metrics
...
- [Unified Highlighter](features/opensearch/opensearch-unified-highlighter.md) - Add matched_fields support for blending matches from multiple fields
- [System Ingest Pipeline](features/opensearch/opensearch-system-ingest-pipeline.md) - Automatic pipeline generation for plugin developers with bulk update support
- [Query Coordinator Context](features/opensearch/opensearch-query-coordinator-context.md) - Search request access and validate API integration for index-aware query rewriting
- [Composite Directory Factory](features/opensearch/opensearch-composite-directory-factory.md) - Pluggable factory for custom composite directory implementations in warm indices
- [Security Manager Replacement](features/opensearch/opensearch-security-manager-replacement.md) - Enhanced Java Agent to intercept newByteChannel from FileSystemProvider
- [Warm Storage Tiering](features/opensearch/opensearch-warm-storage-tiering.md) - WarmDiskThresholdDecider and AutoForceMergeManager for hot-to-warm migration
- [Workload Management](features/opensearch/opensearch-workload-management.md) - Paginated `/_list/wlm_stats` API with token-based pagination and sorting
- [Rule-based Auto-tagging](features/opensearch/opensearch-rule-based-auto-tagging.md) - Automatic workload group assignment based on index patterns and rules
- [Parallel Shard Refresh](features/opensearch/opensearch-parallel-shard-refresh.md) - Shard-level refresh scheduling for improved data freshness in remote store indexes
- [Platform Support](features/opensearch/opensearch-platform-support.md) - Add support for Linux riscv64 platform
...
- [Reporting Release Maintenance](features/reporting/reporting-observability-reporting-release-maintenance.md) - Version increment to 3.1.0-SNAPSHOT and release notes for v3.1.0

### Security

- [Resource Access Control Framework](features/security/security-resource-access-control-framework.md) - Centralized resource sharing SPI with 1:1 backing indices and automatic access evaluation
...
- [Security Dependency Updates](features/security/security-opensearch-dashboards-dependency-updates.md) - 24 dependency updates including Bouncy Castle 1.81, Kafka 4.0.0, and CVE-2024-52798 fix
...
- [Query Insights Release Maintenance](features/query-insights/query-insights-observability-reporting-release-maintenance.md) - Fix flaky integration tests and add multi-node test infrastructure
...
- [Observability Release Maintenance](features/observability/observability-observability-reporting-release-maintenance.md) - Version increments, release notes, and bug fixes for trace analytics
...
- [Observability Trace Analytics](features/dashboards-observability/observability-dashboards-observability-trace-analytics.md) - Merge custom source and data prepper mode, span flyout nested field support

### Neural Search

- [Semantic Field](features/neural-search/neural-search-semantic-field.md) - GA release with mapping transformer, ingest processor, query logic, chunking support, search analyzers, and stats tracking
...
- [Lucene Upgrade](features/neural-search/opensearch-lucene-upgrade.md) - Update hybrid query implementation for Lucene 10.2.1 API compatibility
...
- [Lucene Upgrade](features/learning/opensearch-lucene-upgrade.md) - Update RankerQuery for Lucene 10.2.1 DisiPriorityQueue API change
...
- [Connector/Model Validation Bug Fixes](features/ml-commons/ml-commons-connector-model-validation.md) - Input validation for names/descriptions, schema string type preservation, connector retry policy NPE fix, MCP tool memory fix, Bedrock DeepSeek format fix
...
- [PlanExecuteReflect Agent](features/ml-commons/ml-commons-planexecutereflect-agent.md) - Test coverage for PlanExecuteReflect Agent runner and utilities
...
- [Dashboard Assistant (AI Chatbot)](features/dashboards-assistant/dashboard-assistant-ai-chatbot.md) - T2viz enhancements, streaming buffer, persistent flyout state, admin UI settings
...
- [Testing Library Updates](features/multi-plugin/multi-plugin-testing-library-updates.md) - Update @testing-library/user-event to v14.4.3 in anomaly-detection and index-management dashboards plugins
- [Version Bumps and Release Maintenance](features/multi-plugin/version-bumps-and-observability-reporting-release-maintenance.md) - Version increments across 11 repositories for v3.1.0 release cycle
...
- [Remote Vector Index Build](features/k-nn/k-nn-remote-vector-index-build.md) - GA preparation with tuned buffer sizes, segment size upper bound, renamed settings, metrics fixes
