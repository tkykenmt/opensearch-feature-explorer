...
3. **Update AccessController usage**: Replace `java.security.AccessController.doPrivileged()` with `org.opensearch.secure_sm.AccessController.doPrivileged()` (see AccessController feature)
